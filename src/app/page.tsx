...
export default function Home() {
  return (
    <div className={"bg-[#ffe7ff] flex flex-col jusitfy-center items-center gap-8 h-full"}>
      ...
      <div>
        <h3 className={`${JBMono.className} text-3xl mt-6`}>Where: <a className={"underline hover:text-blue-500"} href={"https://maps.app.goo.gl/8Ti7Rft5gL3n98oc8"}>Coburn Hall</a></h3>
        <h3 className={`${JBMono.className} text-3xl mt-4`}>When: April 5th, 2025</h3>
      </div>
      <ClubCarousel />
      <h2 id="schedule" className={`${InstrSans.className} text-6xl m-6 font-bold`}>Schedule</h2>
      <Itinerary />
    </div>
  );
}
