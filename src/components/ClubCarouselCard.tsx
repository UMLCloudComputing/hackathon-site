...
export const ClubCarouselCard = ({ name, img_url }: { name: string, img_url?: string }) => {
    return (
        <div className="bg-pink-500 flex-none flex flex-col items-center p-4 gap-6 justify-center text-wrap basis-60 grow-1 shadow-xl rounded-2xl shadow-amber-600">
